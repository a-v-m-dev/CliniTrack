...
(0, import_inherits.default)(Changes, events_default);
...
Changes.prototype.removeListener = function(dbName, id) {
  ...
  events_default.prototype.removeListener.call(
    this,
    dbName,
    this._listeners[id]
  );
...
function listenerCount2(ee, type) {
...
(0, import_inherits.default)(Changes$1, events_default);
...
function Changes$1(db, opts, callback) {
  ...
  var complete = opts.complete = once2(function(err, resp) {
    if (err) {
      if (listenerCount2(self2, "error") > 0) {
...
(0, import_inherits.default)(AbstractPouchDB, events_default);
...
(0, import_inherits.default)(Replication, events_default);
...
(0, import_inherits.default)(Sync, events_default);

import {
  ...
  require_vuvuzela,
  v4_default
} from "./chunk-NUUPPOSD.js";
import {
  __toESM,
  init_buffer,
  init_process,
  process
} from "./chunk-ZHUZNDW4.js";
...
var Changes = class extends events_default {
  constructor() {
    super();
    this._listeners = {};
    if (hasLocalStorage()) {
...
var Changes$1 = class extends events_default {
...
var AbstractPouchDB = class extends events_default {
  _setup() {
...
function HttpPouch(opts, callback) {
  ...
  api.removeAttachment = adapterFun$$1("removeAttachment", async function(docId, attachmentId, rev$$1, callback2) {
  ...
  api.putAttachment = adapterFun$$1("putAttachment", async function(docId, attachmentId, rev$$1, blob, type, callback2) {
    if (typeof type === "function") {
      callback2 = type;
      type = blob;
      blob = rev$$1;
...
var Replication = class extends events_default {
  constructor() {
    super();
...
var Sync = class extends events_default {
